<h3 align>👋 こんにちは、ソウ　ケンキ　と申します。</h3>

- :school: 北陸大学の情報系専門先生からIT情報について、様々な知識を教えて頂いて、プログラミングに興味を持たせました。
- :mortar_board:現時点では、情報システム・データベース・C言語・Linux（Ubuntu(仮想環境)・CentOS(Tencent Cloud)・kali(仮想環境)）・アプリケーション開発・ネットワーク・データ構造とアルゴリズム・C++プログラミングなどを勉強しました。
